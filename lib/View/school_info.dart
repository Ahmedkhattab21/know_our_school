      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            reusableTextField(Provider.of<SchoolModel>(context, listen: true).schoolName, Icons.school),
            const SizedBox(height: 15,),
            reusableTextField(Provider.of<SchoolModel>(context, listen: true).schoolAddress, Icons.location_on_rounded),
            const SizedBox(height: 15,),
            reusableTextField(Provider.of<SchoolModel>(context, listen: true).studentsNo, Icons.person),
            const SizedBox(height: 15,),
            reusableTextField(Provider.of<SchoolModel>(context, listen: true).teachersNo, Icons.person),
            Padding(
                    ...
                    child: ButtonTheme(
                      ...
                      child: TextButton(
                        onPressed: () {
                          ...
                          Provider.of<SchoolModel>(context, listen: false).getSchoolInfo();
